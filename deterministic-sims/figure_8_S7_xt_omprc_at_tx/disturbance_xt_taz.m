...
params.k_titr = 0;
params.P = 0;
[t_rr_cl_0,  x_rr_cl_0]    = ode15s(@(t,x)two_comp_tazcl(t, x, params), [0,T], x0_rr, ops);
params.P = 0.1;
[t_rr_cl_01,  x_rr_cl_01]  = ode15s(@(t,x)two_comp_tazcl(t, x, params), [0,T], x0_rr, ops);
params.P = 0.4;
[t_rr_cl_04,  x_rr_cl_04]  = ode15s(@(t,x)two_comp_tazcl(t, x, params), [0,T], x0_rr, ops);
params.P = 0.7;
[t_rr_cl_07,  x_rr_cl_07]  = ode15s(@(t,x)two_comp_tazcl(t, x, params), [0,T], x0_rr, ops);
params.P = 1;
[t_rr_cl_1,  x_rr_cl_1]    = ode15s(@(t,x)two_comp_tazcl(t, x, params), [0,T], x0_rr, ops);
