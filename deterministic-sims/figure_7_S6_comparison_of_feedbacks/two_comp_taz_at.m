...
dx = [params.tlat_Taz-params.delta*Taz-params.kap_taz.*Taz+params.kt*TazP.*OmpR-params.kpc.*FC.*Taz; ...
     -params.delta*TazP+params.kap_taz.*Taz-params.kt*TazP.*OmpR-params.kpc.*FC.*TazP;...
      tl_r-params.delta*OmpR-params.kt.*TazP.*OmpR+params.kp.*Taz.*OmpRP;... 
      -params.delta*OmpRP+params.kt.*TazP.*OmpR-params.kp.*Taz.*OmpRP;... 
      tl_f-params.delta*FC-params.kpc.*FC.*(TazP+Taz);...
      tl_x-params.delta*X];
end
