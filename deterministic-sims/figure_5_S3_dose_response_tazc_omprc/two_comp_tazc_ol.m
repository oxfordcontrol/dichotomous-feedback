function [dx] = two_comp_tazc_ol(t, x, params)
...
dx = [params.tlat_Taz-params.delta*Taz-params.kap_taz.*Taz+params.kt*TazP.*OmpR; ...
     -params.delta*TazP+params.kap_taz.*Taz-params.kt*TazP.*OmpR;...
      tl_r-params.delta*OmpR-params.kt.*TazP.*OmpR+(params.kp.*Taz+params.kpc.*TazC).*OmpRP;... 
      -params.delta*OmpRP+params.kt.*TazP.*OmpR-(params.kp.*Taz+params.kpc.*TazC).*OmpRP;... 
