function [dx] = two_comp_sink_hill_ol(t, x, params)
...
dx = [params.tlat_Taz-params.delta_Taz*Taz-params.kup_hill.*Taz+TazP.*(params.kt*OmpR+params.ktc*OmpRC); ...
      ...
      tl_r-params.delta_OmpR*OmpR-params.kt.*TazP.*OmpR+params.kp.*Taz.*OmpRP;... -
      -params.delta_OmpR*OmpRP+params.kt.*TazP.*OmpR-params.kp.*Taz.*OmpRP;... 
      tl_rc-params.delta_OmpR*OmpRC-params.ktc.*TazP.*OmpRC+params.kpc.*Taz.*OmpRCP;... -
      -params.delta_OmpR*OmpRCP+params.ktc.*TazP.*OmpRC-params.kpc.*Taz.*OmpRCP; ...
